...
function features_shortcode ($first,$content) {
	...
	<div class="col-md-4 col-sm-6 u-xs-MarginBottom30">
	    <div class="Blurb u-PaddingLeft15 u-PaddingRight15">
	        <div class="media u-OverflowVisible">
	            <div class="media-left media-middle--">
	                <div class="Thumb">

	                    <?php echo $output['icon'];?>
	                </div>
	            </div>
	            <div class="media-body">
	                <h4 class="Blurb__hoverText text-uppercase u-MarginTop5"><?php echo $output['heading'];?></h4>
	                <p class="u-LineHeight2"><?php echo $output['content'];?></p>
	            </div>
	        </div>
	    </div>
	</div>
